...
5. **[가격 예측 (Moirai)]** - findings에 있는 예측 결과를 그대로 사용. `pct_change`, `direction`, q10/q90 신뢰구간, 궤적(trajectory) 포함. **예측 데이터가 findings에 없으면 이 섹션을 생략** — 절대 플레이스홀더나 추정값을 작성하지 말 것.
...
- **예측 미실행 (forecast_horizon=0 또는 lookup 쿼리)** → 이 섹션 자체를 생략.
